      ...
      <ImageBackground source={bgImage} style={styles.hero} resizeMode="cover">
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>
            App information, version and developer contact.
          </Text>
        </View>
      </ImageBackground>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.cardText}>
              Modern booking aplikacija za barber studio.
              Brze rezervacije, pregled termina i direktan kontakt – sve na jednom mjestu.
            </Text>
          </View>
