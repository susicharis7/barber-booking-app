...
type NotificationsTabProps = BottomTabScreenProps<MainTabParamList, 'Notifications'>;
type NotificationsSettingsProps = NativeStackScreenProps<
  SettingsStackParamList,
  'NotificationsScreen'
>;
type NotificationsScreenProps = NotificationsTabProps | NotificationsSettingsProps;
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message: 'A new free slot is available today at 16:00. Book now before it’s taken.',
      read: false,
    },
    {
      id: '2',
      title: 'Appointment reminder',
      message: 'Reminder: You have an appointment tomorrow at 11:00.',
      read: false,
    },
    {
      id: '3',
      title: 'Waiting list update',
      message: 'You moved up on the waiting list. You are now position #2.',
      read: true,
    },
  ]);
          ...
          {notifications.map((item) => (
            ...
            >
              ...
              <View style={styles.notificationTextWrap}>
                ...
                <Text
                  style={[styles.notificationPreview, item.read && styles.readText]}
                  numberOfLines={2}
                >
                  {item.message}
                </Text>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalText}>{selected?.message}</Text>
